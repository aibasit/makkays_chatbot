...
STARTUP_PROMPT_REFERENCES: list[PromptRef] = [
    ...
    PromptRef(category="clarification", name="generic_fallback", version="1"),
    PromptRef(category="clarification", name="sales_vs_support_vs_quote", version="1"),
    PromptRef(category="clarification", name="sales_vs_support", version="1"),
    PromptRef(category="clarification", name="sales_vs_quote", version="1"),
    PromptRef(category="clarification", name="wizard_requirement_collection", version="1"),
    PromptRef(category="clarification", name="compatibility_type_selection", version="1"),
    PromptRef(category="clarification", name="use_case_selection", version="1"),
